...
import { FlowsLoginForm } from "./login-form";

export const metadata = {
  title: "Flows — Groner (superadmin)",
};

export default function FlowsLoginPage() {
  return (
    <main
    ...
    >
      ...
      <div className="relative w-full max-w-[420px] scale-in">
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-[12.5px] text-[color:var(--fg-muted)] mt-3 uppercase tracking-[0.18em]">
            Painel superadmin
          </p>
        </div>
        ...
        <div className="mt-6 text-center text-[11px] text-[color:var(--fg-disabled)] tracking-wide uppercase">
          Restrito ao time Groner — gronercrm.com.br
        </div>
      </div>
    </main>
  );
